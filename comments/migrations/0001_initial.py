    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(blank=True, help_text='Upload an image (optional)', max_length=255, null=True, verbose_name='image')),
                ('text_file', cloudinary.models.CloudinaryField(blank=True, help_text='Upload a text file (optional)', max_length=255, null=True, verbose_name='text_file')),
